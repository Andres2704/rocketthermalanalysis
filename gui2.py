...
class Ui_RTA(object):
    def setupUi(self, RTA):
        ...
        self.lasc_logo.setGeometry(QtCore.QRect(480, 350, 151, 191))
        ...
        self.tau_logo.setGeometry(QtCore.QRect(170, 380, 311, 121))
        ...
        self.generate_output = QtWidgets.QAction(RTA)
        self.generate_output.setObjectName("generate_output")
        self.generate_graphs = QtWidgets.QAction(RTA)
        ...
        self.menuResults.addAction(self.generate_output)
        self.menuResults.addSeparator()
        self.menuResults.addAction(self.generate_graphs)
        ...
        RTA.setTabOrder(self.tabWidget, self.material_bulk)
        RTA.setTabOrder(self.material_bulk, self.material_insulator_4)
        RTA.setTabOrder(self.material_insulator_4, self.insulator_thk_4)
        RTA.setTabOrder(self.insulator_thk_4, self.z)
        RTA.setTabOrder(self.z, self.ri_4)
        RTA.setTabOrder(self.ri_4, self.r_steps_4)
        RTA.setTabOrder(self.r_steps_4, self.hm_3)
        RTA.setTabOrder(self.hm_3, self.Ta_3)
        RTA.setTabOrder(self.Ta_3, self.Tc_3)
        RTA.setTabOrder(self.Tc_3, self.burn_time_4)
        RTA.setTabOrder(self.burn_time_4, self.run_bulk)
        RTA.setTabOrder(self.run_bulk, self.radius_outer)
        RTA.setTabOrder(self.radius_outer, self.t_total_bulkhead)
        RTA.setTabOrder(self.t_total_bulkhead, self.generate_output_2)
        RTA.setTabOrder(self.generate_output_2, self.generate_graphs_2)
        RTA.setTabOrder(self.generate_graphs_2, self.propellant_cp)
        RTA.setTabOrder(self.propellant_cp, self.ri_hm)
        RTA.setTabOrder(self.ri_hm, self.motor_length)
        RTA.setTabOrder(self.motor_length, self.burn_time_hm)
        RTA.setTabOrder(self.burn_time_hm, self.propellant_mass)
        RTA.setTabOrder(self.propellant_mass, self.hm_button)
        RTA.setTabOrder(self.hm_button, self.hm_results)
        RTA.setTabOrder(self.hm_results, self.hm_pdfreport)
        RTA.setTabOrder(self.hm_pdfreport, self.type_analysis_case)
    ...
    def retranslateUi(self, RTA):
        ...
        self.material_bulk.setText(_translate("RTA", "Aluminum 6061 - T6"))
        self.liner_material_gp.setTitle(_translate("RTA", "Insulator materials"))
        self.material_insulator_4.setText(_translate("RTA", "EPDM"))
        ...
        self.generate_output_2.setText(_translate("RTA", "Generate Output file"))
        self.generate_graphs_2.setText(_translate("RTA", "Generate Graphs"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_2), _translate("RTA", "Bulkhead"))
        self.groupBox.setTitle(_translate("RTA", "Inputs"))
        self.label_7.setText(_translate("RTA", "Propellant Specific Heat [J/Kg-K]:"))
        self.label_18.setText(_translate("RTA", "Inner combustion chamber diameter [m]:"))
        ...
        self.label_26.setText(_translate("RTA", "formula shown in Equation below:"))
        ...
        self.generate_output.setText(_translate("RTA", "Generate output file"))
        self.generate_graphs.setText(_translate("RTA", "Generate graphs"))
